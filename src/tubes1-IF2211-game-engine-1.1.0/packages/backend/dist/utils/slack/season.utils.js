...
exports.getAddSeasonBody = exports.getSeasonListBody = void 0;
...
const getSeasonListBody = (trigger_id, seasons) => {
    return {
...
exports.getSeasonListBody = getSeasonListBody;
const getAddSeasonBody = (trigger_id) => {
    return {
        trigger_id: trigger_id,
        view: {
            type: "modal",
...
exports.getAddSeasonBody = getAddSeasonBody;
//# sourceMappingURL=season.utils.js.map